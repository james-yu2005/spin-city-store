    ...
    <Layout>
      ...
      <form action="/api/checkout" method="POST">
        ...
        <div className="mt-8">
          ...
          <div className="flex ">
            <h3 className="grow font-bold text-gray-400">Please have at least one rubber in your cart for checkout and have max one rubber - the price is set to $20 which is the price of one rubber</h3>
